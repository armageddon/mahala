...
if Rails.env == "production"
  ...
  FB_APP_KEY = "118834e3a768c685beb996b15539aaf1"
else
  HELLOPULSE_USER_ID = 32
  CALLBACK_URL = "http://localhost:3000/fb_test"
  FB_APP_ID = 105093279544714
  FB_SECRET_KEY = "6f1304c0ca133fae62d90d4cb4b09f4b"
  FB_APP_KEY = "93be83437446f5288629ec944c0fd076"
end
